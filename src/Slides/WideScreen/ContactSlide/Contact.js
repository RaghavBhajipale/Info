  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={twitterImg} alternate="Twitter" redirectURL="https://twitter.com/raghavbhajipale" />
 	  <SocialLogo imgURL={whatsappImg} alternate="whatsapp" redirectURL="https://wa.me/7875006665" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:raghavbhajipale@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/raghavbhajipale/" />
          <SocialLogo imgURL={fbImg} alternate="fb" redirectURL="https://www.facebook.com/raghav.bhajipale" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/raghav-b-22967b89" />
        </SocialMediaIcons>
      </Container>
    );
  }
